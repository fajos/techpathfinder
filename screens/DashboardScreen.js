...
const DashboardScreen = () => {
  ...
  const renderCareerItem = ({ item: career }) => {
    const watermarkSize = normalize(70);
    return (
      <View style={[styles.card, { backgroundColor: colors.card, padding: normalize(18), borderRadius: normalize(16) }]}>
        <Image
